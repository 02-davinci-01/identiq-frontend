// src/app/dashboard/users/utils/themeUtils.ts
// Small pure utilities for theme color conversion and applying CSS vars.
...
/** Apply theme CSS variables to :root (no-op on SSR) */
export function applyThemeVars(baseHex?: string) {
